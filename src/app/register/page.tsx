...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (signUpError) {
      ...
      // Since Email Confirmation is disabled, we can redirect immediately
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <header className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Hesap Oluştur</h1>
          <p className="text-slate-500 text-sm">AdaptA yolculuğunuza bugün başlayın.</p>
        </header>
